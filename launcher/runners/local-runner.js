...
var LocalRunner = /** @class */ (function (_super) {
    __extends(LocalRunner, _super);
    function LocalRunner() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LocalRunner.prototype.killScraper = function (model, site) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        scraper = this.scrapers[scraperIndex];
                        // For Windows, use taskkill command
                        (0, child_process_1.spawn)("taskkill", ["/pid", scraper.pid.toString(), "/f", "/t"]);
                        this.logHelper.consoleLog("SCRAPER ".concat(model, " - ").concat(site, " SHUTDOWN"), states_1.States.SUCCESS);
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 3];
                    case 2:
                        this.logHelper.consoleLog("SCRAPER ".concat(model, " - ").concat(site, " not found"), states_1.States.ERROR);
                        _a.label = 3;
    ...
    LocalRunner.prototype.launchScraper = function (command, model, site) {
        this.logHelper.consoleLog("STARTING 'SCRAPER FOR ".concat(model, " - ").concat(site, "'"), states_1.States.SUCCESS);
        var cmd = "cmd.exe";
        var args = ["/c", command];
